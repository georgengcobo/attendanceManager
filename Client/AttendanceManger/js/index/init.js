...
function GetActiveClasses(ClassesRequestSettings) {
    ...
    $.get(ClassesRequestSettings, function (classesResponse) {
        ...
        $.each(classesResponse.classes, function (index, element) {
            ...
            var editProduct = "<a href='#AttendanceModal' data-toggle='modal' data-backdrop='static' onClick='return MarkRegister(" + element.classId + ");'><img src='./images/icon_edit.png' title='Mark Attendance Register' /></a>";
